...
# Compute purchase price = PV at the discount rate for each asset
purchase_prices = []
for a in assets:
    if hasattr(a, "total_yield"):  # PrivateCredit
        purchase_prices.append(a.present_value(DISCOUNT_RATE))
    else:
        purchase_prices.append(a.present_value(DISCOUNT_RATE))
